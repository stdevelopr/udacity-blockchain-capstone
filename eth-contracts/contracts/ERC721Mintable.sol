...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Only owner are allowed to this.");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "one cannot approve its own address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == owner || isApprovedForAll(owner, msg.sender),
            "sender needs to be the owner or isApprovedForAll() needs to be enabled"
        );
    ...
    function _transferFrom(
        ...
        require(ownerOf(tokenId) == from, "from addressis not the owner");
